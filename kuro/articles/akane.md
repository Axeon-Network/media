...
{% include gallery_item.html image_src='resources/img/articles/kurowiki4450/home.png' caption='A screenshot of the home page of KuroWiki' %} <!-- todo: change it to 5200 when it gets compiled -->
