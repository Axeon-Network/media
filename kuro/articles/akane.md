...
<gallery>
{% include items/gallery.html image_src='kurowiki4450/home.png' caption='A screenshot of the home page of KuroWiki' %} <!-- todo: change it to 5200 when it gets compiled -->
</div>
