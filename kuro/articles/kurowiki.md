...
redirect_from:
  - LexWiki
  - HoriWiki
hatnote: "This article is about the wiki. For the development of KuroWiki and Deltari, see [Development of KuroWiki](Development_of_KuroWiki). For the list of all known KuroWiki builds, see [List of all KuroWiki builds](List_of_all_KuroWiki_builds).<br>This article is incomplete and will be mostly finished on Release Candidate 2."
---

{% include infoboxes/site.html
name='Axeon KuroWiki'
formername='*HoriWiki* (May-June 2025)<br>*LexWiki* (July 2025)'
developer='The *KuroWiki* Contributors (May-August 2025)<br>[Axeon Network](Axeon_Network) (since September 2025)'
...
repoLink='[Axeon-Network/KuroWiki](https://github.com/Axeon-Network/KuroWiki)'
repoHost='GitHub'
status='Available'
...
KuroWiki was planned to be powered by MediaWiki with a custom user interface. However, it was decided instead to build a separate wiki engine, codenamed [*Akane*](Akane), powered by [Jekyll](https://jekyllrb.com).
