...
![A photo of a KDE Plasma error window but the text is just boxes, excluding the title text, in the background, a Discord channel can be seen.](horibyte_moments/softwaregore.jpg){: style="width:50% !important;" title="A photo of a KDE Plasma error window but the text is just boxes, excluding the title text, in the background, a Discord channel can be seen."}
...
![Broken Dolphin (KDE file manager) window as a result of accidental /home folder deletion.)](horibyte_moments/brokendolphinfilemanager.png){: style="width:70% !important;" title="Broken Dolphin (KDE file manager) window as a result of accidental /home folder deletion"}
...
<div class="wiki-gallery" id="Kit-moments-gallery">
    {% include items/gallery.html 
        image_src="horibyte_moments/mc1.0bug.png" 
    ...
    {% include items/gallery.html 
        image_src="horibyte_moments/winrearrowbug.jpg" 
    ...
    {% include items/gallery.html 
        image_src="horibyte_moments/helpicantgetoutahhmoment.jpg" 
    ...
    {% include items/gallery.html 
        image_src="horibyte_moments/mood.jpg" 
    ...
    {% include items/gallery.html 
        image_src="horibyte_moments/wmbmoment.jpg" 
    ...
    {% include items/gallery.html 
     ...
     {% include items/gallery.html 
        image_src="horibyte_moments/taskmgr.png" 
