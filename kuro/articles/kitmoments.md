...
![A photo of a KDE Plasma error window but the text is just boxes, excluding the title text, in the background, a Discord channel can be seen.](res/img/articles/horibyte_moments/softwaregore.jpg){: style="width:50% !important;" title="A photo of a KDE Plasma error window but the text is just boxes, excluding the title text, in the background, a Discord channel can be seen."}
...
![Broken Dolphin (KDE file manager) window as a result of accidental /home folder deletion.)](res/img/articles/horibyte_moments/brokendolphinfilemanager.png){: style="width:70% !important;" title="Broken Dolphin (KDE file manager) window as a result of accidental /home folder deletion"}
...
<div class="wiki-gallery" id="Kit-moments-gallery">
    {% include items/gallery.html 
        image_src="res/img/articles/horibyte_moments/mc1.0bug.png" 
    ...
    {% include items/gallery.html 
        image_src="res/img/articles/horibyte_moments/winrearrowbug.jpg" 
    ...
    {% include items/gallery.html 
        image_src="res/img/articles/horibyte_moments/helpicantgetoutahhmoment.jpg" 
    ...
    {% include items/gallery.html 
        image_src="res/img/articles/horibyte_moments/mood.jpg" 
    ...
    {% include items/gallery.html 
        image_src="res/img/articles/horibyte_moments/wmbmoment.jpg" 
    ...
    {% include items/gallery.html 
        image_src="res/img/articles/horibyte_moments/holyshit.jpg" 
        alt_text="A photo of a Windows Boot Manager screen where the main content is resized to its horizontal half, a reversed color pallete is also shown, with the entries' icons (Win11 and Win10) being missing as well." 
        caption="This is what I get for trying to install Windows Vista manually on a Kaby Lake PC.. - Kit" %}

    {% include items/gallery.html 
        image_src="res/img/articles/horibyte_moments/criticalerror.png" 
     ...
     {% include items/gallery.html 
        image_src="res/img/articles/horibyte_moments/taskmgr.png" 
